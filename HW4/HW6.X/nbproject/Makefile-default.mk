...
SOURCEFILES_QUOTED_IF_SPACED=HW7Main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/HW7Main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/HW7Main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/HW7Main.o

# Source Files
SOURCEFILES=HW7Main.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/HW7Main.o: HW7Main.c  .generated_files/4252063fe64306e18bf92652b59438f6b1256847.flag .generated_files/9c38dd73fa47c8727ca672a3ac38932765b77050.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/HW7Main.o.d 
	@${RM} ${OBJECTDIR}/HW7Main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/HW7Main.o.d" -o ${OBJECTDIR}/HW7Main.o HW7Main.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
else
${OBJECTDIR}/HW7Main.o: HW7Main.c  .generated_files/d936e3e2cbfbf0064f134d16f1ee6d22f87fc5d4.flag .generated_files/9c38dd73fa47c8727ca672a3ac38932765b77050.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/HW7Main.o.d 
	@${RM} ${OBJECTDIR}/HW7Main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/HW7Main.o.d" -o ${OBJECTDIR}/HW7Main.o HW7Main.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
